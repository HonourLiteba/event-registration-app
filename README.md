...
A simple, client-side web application designed to manage technology event registrations. Built with HTML, CSS, and vanilla JavaScript.

## Features Met
- **Task 1 & 3**: Version Control tracking workspace setup and dynamic array data collection storage.
